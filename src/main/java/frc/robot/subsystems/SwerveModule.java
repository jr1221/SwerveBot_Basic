...
public class SwerveModule {
  ...
  private final PIDController m_drivePIDController = new PIDController(ModuleConstants.kModuleDriveP, ModuleConstants.kModuleDriveI, ModuleConstants.kModuleDriveD);

  // Using a TrapezoidProfile PIDController to allow for smooth turning

  private final ProfiledPIDController m_turningPIDController = new ProfiledPIDController(
      ModuleConstants.kModuleTurningP, ModuleConstants.kModuleTurningI, ModuleConstants.kModuleTurningD,
   ...
   */
  public SwerveModule(int driveMotorChannel, int turningMotorChannel, int[] turningEncoderPorts,
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    m_driveMotor.setSpeed(state.speedMetersPerSecond * factor); // TODO: see driveOutput PID controller, which is drive
                                                                // motor
    m_turningMotor.setVoltage(turnOutput + turnFeedforward); // TODO: turn PID Controller
  }
